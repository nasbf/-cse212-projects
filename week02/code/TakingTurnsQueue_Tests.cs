...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The function was inserting each new person in first position, I change the method insert to add to obtain the correct order of the queue.
    ...
    // Defect(s) Found: Same defect as above.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with 0 turns were not being added back into the queue.
    ...
    // Defect(s) Found: the function getNextPerson was not adding the condition for the person with infinite turns (<= 0) and adding queue again.
